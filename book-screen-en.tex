...
%\begin{picture}(0,0)
%\put(0.0,0.05){\makebox[\textwidth]{\scriptsize\heiti\bfseries%
%\hyperref[sec:1-1]{Introduce}\qquad
%\hyperref[sec:1-2]{List}\qquad
%\hyperref[sec:1-3]{Math}\qquad
%\hyperref[sec:1-4]{Theorem}
%}}
%\end{picture}
}
...
\begin{picture}(0,0)
\put(-15,-1.75){\makebox[3cm][c]{\centering\scriptsize\thepage\thinspace/\thinspace\pageref*{LastPage}}}
\end{picture}}

\definecolor{buttoncolor}{rgb}{0.1,0.1,0.1}
\definecolor{lightgray}{gray}{0.9}

\fancyfoot[R]{\scriptsize\sffamily\setlength{\unitlength}{1mm}
\begin{picture}(0,0)
\put(-60,-1.75){%
...
\Acrobatmenu{GoBack}{\scalebox{0.84}{\color{buttoncolor}{\rule[-0.5mm]{0pt}{2mm}GoBack}}}
\Acrobatmenu{FullScreen}{\scalebox{0.84}{\color{buttoncolor}{\rule[-0.5mm]{0pt}{2mm}FullScreen}}}
\Acrobatmenu{Close}{\scalebox{0.84}{\color{buttoncolor}{\rule[-0.5mm]{0pt}{2mm}Close}}}
\Acrobatmenu{Quit}{\scalebox{0.84}{\color{buttoncolor}{\rule[-0.5mm]{0pt}{2mm}Quit}}}%
}
\end{picture}}
...
% Interior color of the background
...
%----- define new column type for tabularx -----
% \newcolumntype{L}{X}
...
\BgThispage
% Slide transition erase from bottom to top
...
The book is organized as follows. Our main results are in \ref{chap:main},
our new algorithm is in \ref{chap:alg}, experimental results are in \ref{chap:experiments},
discussion is in \ref{chap:discussion} and the conclusions follow in~\ref{chap:conclusions}.


\chapter{Preliminaries}
\label{chap:preliminaries}

\section{This is subsection}

\subsection{This is subsubsection}
...
\begin{figure}[htp!]
  \centering
  \includegraphics[width=0.46\linewidth]{image1}
...
\begin{minipage}[t]{0.48\linewidth}
\centering
   \includegraphics[width=0.96\linewidth]{image2}
   \caption{Caption B}
   \label{fig:B}
\end{minipage}
\end{figure}
...
\begin{figure}[htp!]
\centering
\subfloat[Subcaption A]{\includegraphics[width=0.46\linewidth]{image1}}
\qquad
\subfloat[Subcaption B]{\includegraphics[width=0.46\linewidth]{image2}}
...
\chapter{Discussion of \texorpdfstring{{\boldmath$Z=X \cup Y$}}{Z = X union Y}}
