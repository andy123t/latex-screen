...
%\hyperref[sec:1-2]{列表}\qquad
%\hyperref[sec:1-3]{文献引用}\qquad
%\hyperref[sec:1-4]{数学公式}\qquad
%\hyperref[sec:1-5]{定理}\qquad
%\hyperref[sec:1-6]{算法}\qquad
%}}
%\end{picture}
}
...
\subsection{列表的使用}\label{sec:1-2}
